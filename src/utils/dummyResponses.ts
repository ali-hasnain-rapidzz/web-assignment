...
export const dummyArticles: IArticle[] = [
  {
    ...
    description:
      'A deep dive into the latest tech innovations that will shape the future.',
  ...
  },
  {
    ...
    description:
      'Exploring the exciting future of space exploration in the next decade.',
    content:
      'An exciting exploration of space missions and technological advancements.',
    date: '2025-01-22',
    category: 'tech',
    source: 'CNN',
    author: 'Jane Smith',
